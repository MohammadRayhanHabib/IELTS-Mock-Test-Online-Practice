...
export const ReadingHeadingDropZone: React.FC<ReadingHeadingDropZoneProps> = ({ slotIndex, slotCount, headings, answer, selectedLetter, onChange, onSelectionConsumed, firstQuestionNumber, allowDragBack = false, flaggedQuestions, onToggleFlag, onSelectQuestion }) => {
  ...
  return (
    <div onClick={() => onSelectQuestion?.(firstQuestionNumber + slotIndex)} onFocusCapture={() => onSelectQuestion?.(firstQuestionNumber + slotIndex)} className="not-prose mb-1.5 flex items-center gap-1 select-none">
...
const MatchingHeadingsQuestion: React.FC<ReadingQuestionComponentProps> = ({ question, answer, onChange, firstQuestionNumber, visualVariant, flaggedQuestions, onToggleFlag, onSelectQuestion }) => {
