...
const TEST_4 = buildMock(4,[
  {test:T4_P1,questions:[
    question(4,1,1,5,ReadingQuestionType.MATCHING_FEATURES,"R-03 · Matching Features",{instructions:"Match each description with the correct feature, A–E.",questionText:"Museum sound features",options:["reduces reflected sound","creates a small audio area","moves audio with the visitor","provides text alternatives","combines measurements with visitor evidence"],wordBank:["A — absorbent materials","B — directional speakers","C — sound walk","D — inclusive access","E — evaluation"]}),
